                ...
                {project.github === "#stealth" ? (
                  <div className="flex gap-3 mt-2 md:mt-0">
                    <motion.div
                      ...
                      className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full border border-[var(--color-card-border)] bg-[var(--color-card)] text-sm font-semibold tracking-wider text-rose-500/80 transition-all duration-300 opacity-80 cursor-not-allowed select-none"
                    >
